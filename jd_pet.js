...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTEyNzEzMjc0MDAwMDAwMDQ4OTA4NjM1@MTE5MzEwNTEzODAwMDAwMDA0OTc2NzAyNQ==@MTE1MzEzNjI2MDAwMDAwMDYzMzYxMDcz@MTE1NDY3NTIwMDAwMDAwNDk4Nzc1NjM=@MTAxODc2NTEzMjAwMDAwMDAxMzE5MDE2OQ==',
...
function readShareCode () {
  return new Promise( async resolve => {
    const options = {
      url: `https://gitee.com/zhaozhanzhan520/shareCodes/raw/master/jdPet.json?${ new Date() }`, "timeout": 10000, headers: {
